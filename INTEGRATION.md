...
```
github "gilt/BlueSteel" ~> 0.0.0
```

This specifies that Carthage use the latest version of BlueSteel that is API-compatible with 0.0, i.e. any 0.0.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/BlueSteel/releases); there may be a newer version than 0.0 that is no longer API-compatible.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/gilt/BlueSteel/swift3/Documentation/API/index.html) provided by BlueSteel using the statement:
...
Want to learn more about BlueSteel? Check out [the README](https://github.com/gilt/BlueSteel/blob/swift3/README.md) or [the API documentation](https://rawgit.com/gilt/BlueSteel/swift3/Documentation/API/index.html).
