...
**This is the `swift-4` branch of BlueSteel.** It uses **Swift 4.0** and **requires Xcode 9.0 beta** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/gilt/BlueSteel/swift-4/Documentation/API/index.html) provided by BlueSteel in any Swift file using the statement:
...
This specifies that Carthage use the latest version of BlueSteel that is API-compatible with 1.3.0, i.e. any 1.3.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/BlueSteel/releases); there may be a newer version than 1.3.0 that is no longer API-compatible.
...
Want to learn more about BlueSteel? Check out [the README](https://github.com/gilt/BlueSteel/blob/swift-4/README.md) or [the API documentation](https://rawgit.com/gilt/BlueSteel/swift-4/Documentation/API/index.html).
