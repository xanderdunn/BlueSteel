...
**This is the `swift3` branch of BlueSteel.** It uses **Swift 3.0** and **requires Xcode 8** to compile.
...
Once a device-based run destination has been selected, select the appropriate build scheme for the target platform: “BlueSteel-iOS”, “BlueSteel-macOS”, “BlueSteel-tvOS” or “BlueSteel-watchOS”.
...
Want to learn more about BlueSteel? Check out [the README](https://github.com/gilt/BlueSteel/blob/swift3/README.md).
