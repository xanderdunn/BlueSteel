...
This specifies that Carthage use the latest version of BlueSteel that is API-compatible with 0.2, i.e. any 0.2.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/BlueSteel/releases); there may be a newer version than 0.2 that is no longer API-compatible.
