...
This specifies that Carthage use the latest version of BlueSteel that is API-compatible with 1.3, i.e. any 1.3.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/BlueSteel/releases); there may be a newer version than 1.3 that is no longer API-compatible.
