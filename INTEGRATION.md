...
```
github "gilt/BlueSteel" ~> 1.1.0
```

This specifies that Carthage use the latest version of BlueSteel that is API-compatible with 1.1, i.e. any 1.1.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/BlueSteel/releases); there may be a newer version than 1.1 that is no longer API-compatible.
