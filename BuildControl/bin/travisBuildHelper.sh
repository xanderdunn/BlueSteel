...
( set -o pipefail && xcodebuild -project BlueSteel.xcodeproj -configuration Debug -scheme "BlueSteel" -destination "$DESTINATION" -destination-timeout 300 $BUILD_ACTION 2>&1 | tee "BlueSteel-$PLATFORM-$OPERATION.log" | xcpretty )
